...
#define DEBOUNCE_US_SHORT (100 * 1000)
...
int main(void) {
    ...
    bool record_event_pending = false;
    ...
    while (true) {
        ...
        if (current_button_state && !last_button_state && (now_us - last_button_event_us >= DEBOUNCE_US_SHORT)) {
